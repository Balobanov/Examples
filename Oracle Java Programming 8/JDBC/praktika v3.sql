DROP DATABASE IF exists `balobanov`;
CREATE SCHEMA IF NOT exists `balobanov` ;
USE `balobanov`;
...
CREATE TABLE `Musictype` (
	...
	`Musictype_name` varchar(50) NOT NULL UNIQUE,
...
insert into user (Name,Surname,Login,Password,Age, Role_id) 
	value("Muzhik","Pipir","pipka","15999",60,2);
    
insert into user (Name,Surname,Login,Password,Age, Role_id) 
	value("Dimon","Panasenko","ananasik","8897",22,3);
